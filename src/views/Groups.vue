    ...
    <v-card>
      ...
      >
        ...
        <template #item.group_type="{ item }">
          <v-chip
            :color="getTypeColor(item.group_type.code)"
            size="small"
            variant="outlined"
          >
    ...
    <v-dialog v-model="showAddDialog" max-width="700px">
      <v-card>
            ...
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-select
                  ...
                  required
                  return-object
                  :disabled="!editedGroup.program"
                ></v-select>
              </v-col>
              
              <v-col cols="12" md="6">
                <v-select
                  v-model="editedGroup.specialization"
              ...
              <v-col cols="12">
                <v-select
                  v-model="editedGroup.group_type"
                  :items="groupsStore.groupTypes"
                  item-title="label"
                  item-value="code"
                  label="Typ grupy"
        ...
        <v-card-actions>
          ...
          <v-btn color="primary" @click="saveGroup">Zapisz</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
